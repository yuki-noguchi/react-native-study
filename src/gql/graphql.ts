...
export type FetchAllTodosQuery = {
  ...
  todos?: {
    __typename?: 'TodosPage';
    data?: Array<{ __typename?: 'Todo'; id?: string | null; title?: string | null } | null> | null;
  } | null;
};

export const FetchAllTodosDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'query',
      name: { kind: 'Name', value: 'FetchAllTodos' },
      selectionSet: {
        kind: 'SelectionSet',
        selections: [
          {
...
} as unknown as DocumentNode<FetchAllTodosQuery, FetchAllTodosQueryVariables>;
